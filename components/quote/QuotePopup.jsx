...
function QuotePopup() {
  ...
  return (
    <>
      {activePopup === 'quote' &&
        <div className="quote_popup fixed left-0 right-0 bottom-0 flex items-center justify-center pl-[17px] duration-500 transition-[top] top-[-100%] w-full h-full z-[999] overflow-x-hidden overflow-y-auto bg-blueDark2 bg-opacity-50 tablet:!p-20 tablet:h-[100dvh]">
          <div className="popup_container mobile:h-full mobile:overflow-x-hidden mobile:overflow-y-auto bg-white relative p-20 w-full max-w-[640px] z-30 mx-auto" ref={ref}>
            <div className="title_line flex items-center w-full gap-10">
              <div className="popup_title flex-1 text-center font-bold text-2xl ">Provide These Info Please</div>
              <a
                href="/#"
